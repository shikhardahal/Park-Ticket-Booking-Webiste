...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/add_bookings" class="nav-link btn btn-primary">Add Booking</a>
    </li>
...
<script src="{{ asset('dist/js/pages/dashboard.js') }}"></script>
  ...
  <!-- Add JSZip and pdfmake for Excel and PDF export respectively -->
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jszip/3.7.1/jszip.min.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.66/pdfmake.min.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.66/vfs_fonts.js"></script>

 <!-- Add necessary JS and CSS files for DataTables Buttons -->
 ...
 <script src="https://cdn.jsdelivr.net/npm/daterangepicker@3.0.5/daterangepicker.min.js"></script>
  <!-- Add DataTables Buttons library -->
